...
///
/// # Arguments
/// * `_provider` — The `AnthropicProvider` that would perform the streaming HTTP call.
...
// TODO: implement SSE parsing of Anthropic's streaming Messages API response into
// `CompletionChunk`s once the provider's HTTP client supports it (see Step 43).
