...
// mapped to 503, distinguishing "billing isn't set up yet" (Stripe gateway,
// or the subscription/payment repositories, respectively) from a genuine
...
// fails, and 503 if Stripe or a repository a dispatched handler depends on
// (subscriptionRepo/paymentRepo) is unconfigured.
