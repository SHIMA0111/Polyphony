...
// JWTAuth returns middleware that validates Bearer tokens using the given AuthService.
func JWTAuth(authService domainauth.AuthService) echo.MiddlewareFunc {
