...
// `"type": "module"` (see `attachments.spec.ts`'s identical note; the
// MutationObserver technique below is copied/extended from
...
test("AI reply streams incrementally, disables Regenerate while in flight, and settles into a functional final state", async ({
  ...
  // Credited generously enough to cover both this spec's initial streamed
  // send and its follow-up regenerate.
